...
class PatternDataset(InMemoryDataset):
    ...
    urls = {
        'PATTERN_pq_010_001_005': f'{root_url}/raw/main/PATTERN_010.zip',
        'PATTERN_pq_012_001_005': f'{root_url}/raw/main/PATTERN_012.zip',
        'PATTERN_pq_014_001_005': f'{root_url}/raw/main/PATTERN_014.zip',
        'PATTERN_pq_016_001_005': f'{root_url}/raw/main/PATTERN_016.zip'
    }
    ...
    def process(self):
        inputs = torch.load(self.raw_paths[0])      # PATTERN_v2.pt
